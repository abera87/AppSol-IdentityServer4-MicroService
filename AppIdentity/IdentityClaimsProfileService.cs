...
namespace AppIdentity
{
     public class IdentityClaimsProfileService : IProfileService
    {
        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            claims.Add(new Claim(ClaimTypes.Role, AppRoles.Consumer)); // need this for role-based authorization - https://stackoverflow.com/questions/40844310/role-based-authorization-with-identityserver4
